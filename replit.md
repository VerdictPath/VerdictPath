...
**Visual Assets**: The app uses custom pirate-themed images including a treasure map image (Treasure Map_1762016241708.png) for all Case Roadmap thumbnails and icons, and a treasure chest image (Treasure Chest Full Cartoon_1762017505115.png) for all treasure/coin-related features including "Earn treasure as you progress" on the landing page and the main Treasure Chest button on the dashboard.
