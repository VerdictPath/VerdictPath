    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          ${statementData.disclaimer ? `
          <div style="margin-top: 25px; padding: 15px; background: #fefce8; border: 1px solid #fde68a; border-radius: 8px;">
            <h4 style="margin: 0 0 8px 0; color: #92400e; font-size: 13px; text-transform: uppercase;">Disclaimer</h4>
            <p style="margin: 0; color: #78350f; font-size: 12px; line-height: 1.5; white-space: pre-wrap;">${statementData.disclaimer}</p>
          </div>
          ` : ''}
